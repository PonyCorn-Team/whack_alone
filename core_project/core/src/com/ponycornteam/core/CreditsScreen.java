...
public class CreditsScreen implements Screen  {
    ...
    public CreditsScreen(final Core gam) {
    	game = gam;
		...
		final float buttonX = ( game.WIDTH - BUTTON_WIDTH ) / 2;
		 float currentY = 200;
	       // label "welcome"
       Label welcomeLabel = new Label( "Credits", skin );
       welcomeLabel.setX(( (  game.WIDTH - welcomeLabel.getWidth() ) / 2 ));
       welcomeLabel.setY(( currentY + 200 ));
       stage.addActor( welcomeLabel );
       
       Label lbl1 = new Label( "Game : Ponycorn-team", skin );
       lbl1.setX(( (  game.WIDTH - lbl1.getWidth() ) / 2 ));
       lbl1.setY(( currentY + 170 ));
       stage.addActor( lbl1 );

       Label lbl2 = new Label( "Story : Ponycorn-team", skin );
       lbl2.setX(( (  game.WIDTH - lbl2.getWidth() ) / 2 ));
       lbl2.setY(( currentY + 150 ));
       stage.addActor( lbl2 );
       
       Label lbl3 = new Label( "Game engine : libgdx", skin );
       lbl3.setX(( (  game.WIDTH - lbl3.getWidth() ) / 2 ));
       lbl3.setY(( currentY + 130 ));
       stage.addActor( lbl3 );

       Label lbl4 = new Label( "Music : Newsground", skin );
       lbl4.setX(( (  game.WIDTH - lbl4.getWidth() ) / 2 ));
       lbl4.setY(( currentY + 110 ));
       stage.addActor( lbl4 );
       
       Label lbl5 = new Label( "       Matt-Porter, Aztech, DrMackfox, Aaraboga, Darknessbreaker, Arnas", skin );
       lbl5.setX(( (  game.WIDTH - lbl5.getWidth() ) / 2 ));
       lbl5.setY(( currentY + 95 ));
       stage.addActor( lbl5 );

       Label lbl6 = new Label( "Sound Effect : freesound.org", skin );
       lbl6.setX(( (  game.WIDTH - lbl6.getWidth() ) / 2 ));
       lbl6.setY(( currentY + 75 ));
       stage.addActor( lbl6 );
